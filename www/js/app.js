...
.config(function($ionicConfigProvider, $sceDelegateProvider, $authProvider, $httpProvider, BASE){
  ...
  $authProvider.configure({
    apiUrl: BASE,
    emailSignInPath: '/auth/auxiliaries/sign_in',
    accountUpdatePath: '/auth/auxiliaries',
    signOutUrl: '/auth/auxiliaries/sign_out',
    emailRegistrationPath: '/auth/auxiliaries',
    tokenValidationPath: '/auth/auxiliaries/validate_token',
